        ...
        if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
            ...
            if (p("ul.search-list li").remove(), p(this).parent().hasClass("bookmark-input") && (i = !0), "" != s) {
                ...
                p.getJSON("../app-assets/data/" + h + ".json", function(e) {
                    ...
                    "" == l && "" == r && (r = '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100"><div class="d-flex justify-content-start"><span class="mr-75 bx bx-error-circle"></span><span>No results found.</span></div></a></li>'), c = l.concat(r), p("ul.search-list").append(c)
                })
            } else if (!0 === i) {
